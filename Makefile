...
help:
	...
	@printf "  prototype-maturity-identity Validate the inactive Prototype Maturity Git identity\n"
...
openproject-standardize-delivery-art:
	...
	./products/openproject/scripts/openproject_standardize_delivery_art.sh
...
.PHONY: prototype-maturity-identity
prototype-maturity-identity:
	@test -n "$(ACTION)" || { echo "ACTION is required: validate"; exit 1; }
...
.PHONY: repository-provisioning-identity
...
validate:
	...
	python3 scripts/prototype_landing_identity.py validate
	...
	python3 products/openproject/scripts/validate_delivery_art_blocker_workflow_projection.py --repo-root . --oos-repo-root "$(OOS_REPO_ROOT)"
