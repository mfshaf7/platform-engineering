...
- shared platform and provisioning commands:
  ...
  - `make prototype-closure-identity ACTION=<validate|commission> ARGS="<bounded identity arguments>"` verifies the [Prototype Closure identity](docs/components/operator-orchestration-service/prototype-closure-identity.md) without enabling runtime
