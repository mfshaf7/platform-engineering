...
| `confirm-stage-promotion-readiness.yaml` | [confirm-stage-promotion-readiness.md](confirm-stage-promotion-readiness.md) | manual | records approval of the current stage candidate |
