...
OPENPROJECT_AUTOMATION_PROJECT_IDENTIFIERS_JSON="${OPENPROJECT_AUTOMATION_PROJECT_IDENTIFIERS_JSON:-}"
OPENPROJECT_AUTOMATION_TOKEN_NAME="${OPENPROJECT_AUTOMATION_TOKEN_NAME:-openproject-workspace-proposals-v1}"
OPENPROJECT_AUTOMATION_ROLE_NAMES_JSON="${OPENPROJECT_AUTOMATION_ROLE_NAMES_JSON:-[\"Reader\",\"Work package creator\",\"Work package editor\",\"Work package structure editor\"]}"
...
kubectl_cmd -n "${OPENPROJECT_NAMESPACE}" exec -i "deploy/${OPENPROJECT_DEPLOYMENT}" -- env \
  ...
  TARGET_PROJECT_IDENTIFIERS_JSON="${OPENPROJECT_AUTOMATION_PROJECT_IDENTIFIERS_JSON}" \
